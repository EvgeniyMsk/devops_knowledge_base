...
Материалы по сетевым технологиям: модели OSI и TCP/IP, L2/L3, практическая диагностика. Разделы опираются на планы в `materials/networking/` и содержат определения, примеры, практику и ссылки на дополнительное чтение.
