...
**Цель:** диагностировать проблемы с DNS за минуты, а не часы: понимать разницу между рекурсивным и авторитативным сервером, типы записей (A, AAAA, CNAME, TXT, SRV), TTL и кэширование, split-horizon и DNS в Kubernetes. Уметь объяснить, почему приложение работает по IP, но не по hostname.
