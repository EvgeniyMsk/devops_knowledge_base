...
**Цель:** выстроить production-ready доставку в кластер: упаковка приложений в Helm (структура чарта, values.yaml, шаблоны, hooks), GitOps (Argo CD, Flux, стратегии синхронизации), CI (сборка образов, сканирование, деплой). В разделе — примеры манифестов с комментариями и best practices для production.

Отдельные страницы: [Helm](helm.md), [ArgoCD](../gitops/argocd.md).
...
- [Helm](helm.md) — обзор в этой базе знаний
- [ArgoCD](../gitops/argocd.md) — обзор в этой базе знаний
