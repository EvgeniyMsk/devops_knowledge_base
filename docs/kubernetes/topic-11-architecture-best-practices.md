...
**Цель:** проектировать и эксплуатировать кластеры на уровне Middle+ / Senior: стратегия namespace’ов, мультикластер, стратегии деплоя (Blue/Green, Canary), оптимизация затрат, обновление кластера, Disaster Recovery. В разделе — примеры манифестов с комментариями и best practices для production.
