...
Материалы по Git структурированы по разделам. Каждый раздел опирается на план в `materials/git/` и содержит определения терминов, примеры кода, практики из production, паттерны и антипаттерны, а также ссылки на дополнительное чтение.
