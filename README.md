# DevOps база знаний
**Сайт:** [devops.evgeniymsk.ru](https://devops.evgeniymsk.ru/)
---
## Содержание

- **Networking** — сетевые технологии  
- **Git** — базис, индекс, ветки, remote, отмена, продвинутые операции, конфигурация, Git в CI/CD  
...
---
## Лицензия
Использование материалов — по согласованию с автором. См. раздел «Обратная связь» на сайте.